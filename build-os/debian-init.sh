...
[ -r ${OS_TEMPDIR}/etc/issue ] || \
	...
	sudo DEBOOTSTRAP_DIR=${STAGING_DIR}/debootstrap-debian \
		${STAGING_DIR}/debootstrap-debian/debootstrap \
		--arch=${OS_ARCH} --variant=minbase \
		--keyring ${STAGING_DIR}/debootstrap-debian/usr/share/keyrings/debian-archive-keyring.gpg \
